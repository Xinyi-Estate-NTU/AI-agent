...
from .utils import extract_json_from_llm_response, generate_search_explanation, map_llm_params_to_internal
...
class WebQueryProcessor:
    ...
    async def process_web_query(self, query: str, scrape_results: bool = True) -> Dict[str, Any]:
        """
